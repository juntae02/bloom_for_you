...
> 기존의 선물은 순간적인 감동에 그치는 경우가 많습니다.  
> 우리는 받는 이가 꽃을 직접 기르지 않더라도, 꽃의 성장 과정을 함께 공유하며 지속적인 기쁨과 진심이 전해지는 새로운 형태의 선물을 만들고자 했습니다.  
> 또한, 식물 재배의 어려움과 실패에 대한 부담을 로봇 기술로 해결함으로써, 누구나 꽃을 쉽게 기를 수 있도록 돕는 것을 목표로 했습니다.
<br />
